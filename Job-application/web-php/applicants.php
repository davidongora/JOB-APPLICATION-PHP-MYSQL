  ...
  <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">applicants DATA</span>
                </div>
...
$count = 1;
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<td>";
      echo "<a href='app-delete.php?appid=" . $row["appid"] . "'><button style='margin-right: 20px;'>Delete</button></a>";
      echo "<a href='app-edit.php?appid=" . $row["appid"] . "'><button>Edit</button></a>";
      echo "</td>";
   ...
   $sql = "SELECT * FROM applicants LIMIT $this_page_first_result, $results_per_page";
   $result = mysqli_query($conn, $sql);
   ...
   for ($page = 1; $page <= $number_of_pages; $page++) {
     echo "<a href='applicants.php?page=" . $page . "'>" . $page . "</a>";
   }
   echo "</div>";
...
?>
  ...
  <div class="form-popup" id="add-form">
    <form action="app-add.php" method="post" class="form-container">
      <h2>Add Admin</h2>
      <label for="name"><b>Name</b></label>
      <input type="text" placeholder="Enter name" name="name" required>

      <label for="name"><b>appid</b></label>
      <input type="text" placeholder="Enter appid" name="appid" required>

      <label for="category"><b>category</b></label>
      <input type="text" placeholder="Enter category" name="category" required>

      <label for="registration date"><b>regdate</b></label>
      <input type="text" placeholder="Enter registration date" name="regdate" required>
