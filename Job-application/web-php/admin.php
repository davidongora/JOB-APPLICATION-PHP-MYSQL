  ...
  <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">ADMINS DATA</span>
                </div>
...
$count = 1;
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<td>" . $row["name"] . "</td>";
      echo "<td>";
      echo "<a href='admin-delete.php?id=" . $row["AdmNo"] . "'><button style='margin-right: 20px;'>Delete</button></a>";
      echo "<button onclick='showEditForm(" . $row["AdmNo"] . ")'>Edit</button>";

      //echo "<a href='admin-edit.php?id=" . $row["AdmNo"] . "'><button>Edit</button></a>";
      echo "</td>";
...
?>
  ...
  <div class="form-popup" id="add-form">
    <form action="admin-add.php" method="post" class="form-container">
      <h2>Add Admin</h2>
...
function showEditForm(id) {
  ...
  // Set the form action URL to include the record ID
  form.action = "admin-edit.php?id=" + id;
