...
$count = 1;
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<td>" . $row["name"] . "</td>";
      echo "<td>";
      echo "<a href='cat-delete.php?id=" . $row["catId"] . "'><button style='margin-right: 20px;'>Delete</button></a>";
      echo "<a href='cat-edit.php?id=" . $row["catId"] . "'><button>Edit</button></a>";
      echo "</td>";
...
?>
  ...
  <div class="form-popup" id="add-form">
    <form action="cat-add.php" method="post" class="form-container">
      <h2>Add category</h2>
